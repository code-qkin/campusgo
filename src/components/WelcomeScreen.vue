...
<template>
  <div class="relative w-full h-screen overflow-hidden bg-brand-bg text-on-surface flex items-center justify-center font-sans">
    ...
    <main class="relative z-10 flex flex-col items-center justify-center text-center px-8 max-w-4xl max-h-screen pt-12 md:pt-0">
      ...
      <div class="mb-8 flex items-center justify-center">
        <div class="relative group cursor-pointer">
          ...
          <!-- Logo Frame -->
          <div class="relative bg-[#1a1a1a]/85 border border-[#2a2a2a] p-8 rounded-full shadow-[0_0_40px_10px_rgba(255,95,82,0.15)] transform transition-transform group-hover:scale-105 duration-500">
            <Bus class="w-20 h-20 text-brand-primary duration-500" />
      ...
      <!-- Typography Section -->
      <div class="space-y-4">
        <h1 class="font-display text-5xl md:text-6xl font-extrabold text-on-surface tracking-tighter drop-shadow-lg">
          CampusGo
        </h1>
        <p class="font-sans text-lg md:text-xl text-on-surface-variant max-w-lg mx-auto opacity-95 leading-relaxed font-light">
      ...
      <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl">
